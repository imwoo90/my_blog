                ...
                article { class: "flex flex-col gap-8",
                    header { class: "flex flex-col gap-4 px-4",
                        div { class: "flex items-center gap-2 text-sm",
                            ...
                            span { class: "material-symbols-outlined text-text-dark/40 dark:text-gray-500 !text-sm",
                                "chevron_right"
                            }
                            span { class: "text-text-dark dark:text-white font-medium",
                    ...
                    div { class: "prose max-w-none px-4 transition-colors",
                        ...
                        p { "The core of the library handles the heavy lifting:" }
                        ul {
                            li {
                                strong { "Data Processing:" }
                                " Efficiently parsing and transforming large JSON or CSV datasets."
                            }
                            li {
                                strong { "Layout Calculation:" }
                                " Performing complex geometric calculations for chart layouts (e.g., force-directed graphs, treemaps)."
                            }
                            li {
                                strong { "Rendering:" }
                                " Drawing directly to an HTML5 Canvas element with a custom rendering pipeline optimized for speed."
                            }
                        }
    ...
    if data.is_empty() {{
        ...
        sum / data.len() as f64
                        ...
                        p {
                            "The "
                            code { "#[wasm_bindgen]" }
                            " attribute is the magic that makes these Rust functions and structs available to JavaScript, creating a seamless bridge between the two languages."
                        }
                        div { class: "grid grid-cols-1 md:grid-cols-2 gap-8 my-8",
                            img {
                                class: "rounded-lg border border-text-dark/10 dark:border-white/10 w-full h-auto object-cover shadow-sm",
                                src: "https://lh3.googleusercontent.com/aida-public/AB6AXuDn1UYUGXZA0JSs_rAfERLePldD4OcbrusEaOmmqaYOEeppGFb-k8UgQ0NjR2pcuX8xnOLdwExx49rb0O8xNDB5qQ-w9UgDV1wvRMOI5fYJYHP39Nsxjc4hY3EkGXCQQlVAR5MsiQsU4XizQuTY6SzawO11zpA54rvWWPNKD9G77guy5rnDonoIyjmWLa4q_nCjTHWwY-1hk_y4VBiCiJsNJeYeLiKB55vAoJ5NQeXPsAN_fRh3mnIXnFKgLoxbMslJpYyq4EFq9xv4",
                                alt: "Architectural diagram of the Wasm engine",
                            }
                            img {
                                class: "rounded-lg border border-text-dark/10 dark:border-white/10 w-full h-auto object-cover shadow-sm",
                                src: "https://lh3.googleusercontent.com/aida-public/AB6AXuCYq39SdXr4TMm7kO_Uy2xyaUFPK1uvdOICjaA2ADD3_vc2InSy1JSEAuoVrxImuP5dRw3ficRdKA9GU2KSp3Pqsnsbs6n3ISv0Ne9RUlQzeYkEd1ryMJrSOhllPrGFz5MV2MODT1R2yln-ixaVZsIl7yC2WMVZ22Pj72o9giQ13hixtw-ahBR53KQo4UAnv87qErJQUbR5W4t3ED_VlnRmLiq63ADnGpCQYUy5dVxBZcEj0uaeD6lOTpIJCXxeRvtyvSc4W4u263Vd",
                        ...
                        div { class: "bg-surface-dark dark:bg-white/5 rounded-xl p-8 flex flex-col sm:flex-row items-center gap-6 mt-12 border border-surface-border dark:border-white/10 transition-colors shadow-lg",
                            div { class: "grow",
                                h3 { class: "text-white dark:text-white text-2xl font-bold transition-colors",
                                    "Explore the Project"
                                }
                                p { class: "text-white/70 dark:text-text-light mt-2 transition-colors",
                                    "Dive into the source code, check out the live demo, and see the performance for yourself."
                                }
                            }
                            a {
                                class: "inline-flex items-center justify-center gap-2 whitespace-nowrap bg-primary text-white font-bold text-base px-8 py-4 rounded-lg hover:bg-primary-light transition-all active:scale-95 w-full sm:w-auto shadow-md",
                                href: "#",
                                svg {
                                    class: "size-6",
                                    fill: "currentColor",
                    ...
                    div { class: "flex flex-col gap-8",
                        ...
                        div { class: "flex flex-col gap-6",
                            div { class: "flex items-start gap-4",
                                img {
                                    class: "size-10 rounded-full border border-text-dark/10 dark:border-white/10",
                                    src: "https://lh3.googleusercontent.com/aida-public/AB6AXuAXB_uuet1wxQCv_HNA5OKhsrKNttI8Dk57pwThxYJLYpDEhDatb8_4amKO5dJoR4O8HAHGGn8jVpIVajTVY8eCPjeKRM5t_Aggqg9fArFKgIVqXzO8ZDcbE0u4pVmB7Bjtsv-wrwcbyaJ9EoGIkN3o6xZiUODixQ5gTySSUTNdK82w6pgxS0-z0DqPuQlZN3SIDAKTZ9mDWrNRfKjvDn87afEIg7cFXg0Fi82r1O1F1jh0GPPhHK6RRionBitolD-t_x3Duw-DtzHw",
                                    alt: "User avatar",
                                }
                                div { class: "flex-1",
                            ...
                            div { class: "flex flex-col gap-8",
                                div { class: "flex items-start gap-4",
                                    img {
                                        class: "size-10 rounded-full border border-text-dark/10 dark:border-white/10",
                                        src: "https://lh3.googleusercontent.com/aida-public/AB6AXuAKTYnKgoWMM15UTvOugoMXvYWs9d-Yo9RCvP6v_ilmnnp8-_OLVqoz1-1AXhD1nNrSq9Z6DfjYY84gVr6eNvJB9O-GYThPTVr5TKapPERZQYYJqdPdks41NivF_GEpX82s4WZ3YZR39bKzgBc7MnkRyKSpauNcQoLJE1pg6IgE5PeMQOMCD0-4TATNGCc_JqpTcEdqQl_9Xelzn2FMFigdAiJ3_Vlsl9CvsliwUySKm-99ilP7IdYUSYQ0v9A6FapxMTzVqSRGWpI7",
                                        alt: "User avatar",
                                    }
                                    div { class: "flex-1",
                                        div { class: "flex items-center gap-2",
                                            span { class: "font-bold text-text-dark dark:text-white transition-colors",
                                                "Alice"
                                            }
                                            span { class: "text-xs text-text-dark/40 dark:text-gray-400 transition-colors",
                                                "2 days ago"
                                            }
                                        }
